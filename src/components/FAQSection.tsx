        ...
        <section id="faq" className="py-20 bg-gray-50">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                    ...
                    <p className="text-xl text-gray-600">「簡単すぎて不安...」そんな疑問にお答えします。</p>
                </div>
                        ...
                        <CardContent className="p-8">
                            <div className="flex items-start">
                                ...
                                <div className="flex-1">
                                    <h3 className="text-xl font-bold text-gray-900 mb-2">本当にセキュリティは大丈夫？</h3>
                    ...
                    <Card className="border-0 shadow-md rounded-2xl hover:shadow-lg transition-shadow">
                        <CardContent className="p-8">
                            <div className="flex items-start">
                                ...
                                <div className="flex-1">
                                    <h3 className="text-xl font-bold text-gray-900 mb-2">うちの学校も対応してる？</h3>
                                    <p className="text-gray-600">
                    ...
                    <Card className="border-0 shadow-md rounded-2xl hover:shadow-lg transition-shadow">
                        <CardContent className="p-8">
                            <div className="flex items-start">
                                ...
                                <div className="flex-1">
                                    <h3 className="text-xl font-bold text-gray-900 mb-2">本当に完全無料？</h3>
                                    <p className="text-gray-600">
